...
import { Paciente } from '@/shared/model/pacientems/paciente.model';
...
describe('Service Tests', () => {
  describe('Paciente Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new Paciente(123, 0, 'AAAAAAA', 'AAAAAAA', 'AAAAAAA', 'M', 'AAAAAAA', currentDate, 'AAAAAAA', 'AAAAAAA');
    });
