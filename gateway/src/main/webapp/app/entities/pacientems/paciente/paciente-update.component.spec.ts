      ...
      mountOptions = {
        ...
        provide: {
          ...
          infoSocioeconomicaService: () =>
            sinon.createStubInstance<InfoSocioeconomicaService>(InfoSocioeconomicaService, {
              retrieve: sinon.stub().resolves({}),
            } as any),
          historialMedicoService: () =>
            sinon.createStubInstance<HistorialMedicoService>(HistorialMedicoService, {
              retrieve: sinon.stub().resolves({}),
            } as any),
          entidadFederativaService: () =>
            sinon.createStubInstance<EntidadFederativaService>(EntidadFederativaService, {
              retrieve: sinon.stub().resolves({}),
            } as any),
        },
      };
