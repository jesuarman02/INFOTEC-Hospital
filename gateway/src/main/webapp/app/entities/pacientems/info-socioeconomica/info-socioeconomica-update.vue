  ...
  <div class="row justify-content-center">
    <div class="col-10">
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        <h2 class="mb-4 text-center">Formulario de Información Socioeconómica</h2>

        <div class="card mb-4 shadow-sm" v-if="!infoSocioeconomica.id">
          <div class="card-header bg-primary text-white">
            <h5 class="mb-0"><font-awesome-icon icon="search"></font-awesome-icon> Identificar al Paciente</h5>
          </div>
          <div class="card-body">
            <div class="form-group mb-0">
              <label class="form-control-label">Ingrese el ECU del paciente para iniciar el cuestionario</label>
              <div class="input-group">
                ...
                <div class="input-group-append">
                  ...
                  <button class="btn btn-outline-danger" type="button" v-if="pacienteEncontrado" @click="limpiarBusqueda()">
                    <font-awesome-icon icon="times"></font-awesome-icon> Limpiar
                  </button>
                </div>
              </div>
            </div>
        ...
        <div v-if="pacienteEncontrado || infoSocioeconomica.id">
        ...
        <div class="mt-4" v-if="pacienteEncontrado || infoSocioeconomica.id">
...
<script lang="ts" src="./info-socioeconomica-update.component.ts"></script>