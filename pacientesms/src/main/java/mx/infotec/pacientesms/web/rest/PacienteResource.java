...
/**
 * REST controller for managing {@link mx.infotec.pacientesms.domain.Paciente}.
 */
@RestController
...
public class PacienteResource {
    ...
    private static final String ENTITY_NAME = "pacientemsPaciente";
     ...
     */
    @PostMapping("")
    public Mono<ResponseEntity<PacienteDTO>> createPaciente(@Valid @RequestBody PacienteDTO pacienteDTO)
    ...
    @GetMapping("/ecu/{ecu}")
    public Mono<ResponseEntity<Paciente>> getPacienteByEcu(@PathVariable Integer ecu) { // <--- CAMBIO AQUÍ

        Mono<Paciente> paciente = pacienteRepository.findByEcu(ecu); // <--- CAMBIO AQUÍ
