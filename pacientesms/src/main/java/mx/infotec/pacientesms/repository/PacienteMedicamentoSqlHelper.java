...
public class PacienteMedicamentoSqlHelper {

    public static List<Expression> getColumns(Table table, String columnPrefix) {
        List<Expression> columns = new ArrayList<>();
        columns.add(Column.aliased("id", table, columnPrefix + "_id"));
        columns.add(Column.aliased("dosis", table, columnPrefix + "_dosis"));
        columns.add(Column.aliased("frecuencia", table, columnPrefix + "_frecuencia"));
