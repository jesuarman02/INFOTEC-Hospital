package mx.infotec.pacientesms.config;
...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("mx.infotec.pacientesms.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("mx.infotec.pacientesms.security.DomainUserDetailsService", "createSpringSecurityUser");
